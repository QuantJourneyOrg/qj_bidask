"""
Integration tests for all EDGE estimators.

Comprehensive integration test suite validating consistency across all
estimator variants and parameter combinations.
...
def simulate_prices(n=100, spread=0.01, seed=42):
    ...
    for t in range(n):
        ...
        # open_price = prev_close  # Open at previous close (for simplicity)
        ...
        opens.append(o_trade)
        highs.append(H)
        lows.append(L)
        closes.append(c_trade)
        prev_close = c_trade
